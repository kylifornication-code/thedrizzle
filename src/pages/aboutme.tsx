...
const career: CareerEntry[] = [
  {
    id: 'tmpl-sr-manager',
    icon: '🚀',
    shortTitle: 'Sr Manager, Security Engineering Partnerships',
    ...
    shortDescription: 'Leading security engineering partnerships and driving strategic initiatives across Disney\'s security landscape. Building bridges between security teams and engineering organizations to create more secure products and experiences.',
  },
  {
    id: 'tmpl-sr-staff-secmgr',
    icon: '🔓',
    shortTitle: 'Sr Staff Security Engineer | Manager',
    ...
    shortDescription: 'Secured the magic by making security a resume-worthy accolade for developers. Managed enterprise-wide secure development services and programs focused on developer enablement, overseeing tools like Snyk, Whitehat, Checkmarx, and Tenable.',
  ...
  },
  {
    ...
    icon: '⚙️',
    shortTitle: 'Sr Software Product Engineer, DevOps Platforms',
    ...
    shortDescription: 'Led 4 functional engineering teams across entitlements, billing automation, and engineering tools. Focused on ecosystem strategy, reducing enterprise licensing spend, and representing Disney at external events like DevOps Days and AWS RE:Invent.',
  ...
  },
  {
    ...
    icon: '📈',
    shortTitle: 'Senior Product Manager, Developer Enablement',
    ...
    shortDescription: 'Navigated the 21st Century Fox acquisition, rationalizing $2.5M in duplicate service contracts. Led GitHub.com approval across the company and consolidated multiple contracts, saving $1.2M in licensing costs.',
  ...
  },
  {
    ...
    icon: '🔧',
    shortTitle: 'DevOps Platform Product Owner',
    ...
    shortDescription: 'First product person in Corporate engineering, scaling GitLab from 50 to 10k users. Ran a million-dollar migration project, reducing costs by $500k. Built a Slackbot community of 150+ technologists and measured DORA metrics before it was mainstream.',
  ...
  },
  {
    ...
    icon: '🎯',
    shortTitle: 'Product Owner/Solutions Engineer',
    ...
    shortDescription: 'Started during fire drills, learned enterprise dynamics, and built self-service migration tools. Developed relationships across teams and executives, making a name as a collaborator who could get into meetings others couldn\'t access.',
  ...
  },
  {
    ...
    icon: '💻',
    shortTitle: 'Web Design & Marketing Consultant',
    ...
    shortDescription: 'Built ~50 custom websites and web apps, scaling from LAMP to AWS with load balancers and autoscaling. This side hustle provided the perfect foundation for my Disney cloud migration work and taught me rapid prototyping and modular design.',
  ...
  },
  {
    ...
    icon: '🏢',
    shortTitle: 'Partner & Program Mgmt: Lenovo Consultant',
    ...
    shortDescription: 'First big company experience at Zones LLC, working with Lenovo. Developed GTM channel strategy, managed $25M+ quarterly pipeline, and created cross-brand programs that helped every brand exceed their targets. Learned the intersection of business and technology.',
  ...
  },
  {
    ...
    icon: '🔒',
    shortTitle: 'Technical Marketing Associate',
    ...
    shortDescription: 'Rhino Security Labs - Led remote dev team on website redesign, built automated CRM pipelines, and helped launch their first managed service provider offering. Learned that automation is key to scaling security operations.',
  },
  {
    id: 'tmpl-director-marketing-pnw',
    icon: '🏃‍♂️',
    shortTitle: 'Director of Marketing PNW',
    ...
    shortDescription: 'Xperience Adventures - My first startup! Grew events from dozens to 200+ by developing remote planning models and partnerships. Learned to hustle, say yes to challenges, and that good things happen through motion and win-win situations.',
  },
  {
    id: 'tmpl-central-munchies',
    icon: '🍕',
    shortTitle: 'Founder, Central Munchies',
    ...
    shortDescription: 'College startup solving late-night food delivery in Ellensburg. Built a mobile web-app through three full rewrites, adding 12 features beyond the original POC. Learned rapid iteration, user research, and the full startup journey from problem to solution.',
  },
];

// Derive a period string for the timeline display (short format with dashes)
function toTimelinePeriod(period: string): string {
  return period
    .replace(/\s+to\s+/g, ' - ')
    .replace(/\s+·.*$/, '');
}
...
export default function AboutMe(): JSX.Element {
  ...
  const [selectedJob, setSelectedJob] = useState<CareerEntry | null>(null);
  const [currentIndex, setCurrentIndex] = useState(0);
  const timelineScrollRef = useRef<HTMLDivElement>(null);

  const openModal = useCallback((entry: CareerEntry) => {
  ...
  const scrollToItem = useCallback((index: number) => {
    const newIndex = Math.max(0, Math.min(index, career.length - 1));
  ...
  const isLastItem = currentIndex === career.length - 1;
                    ...
                    {career.map((entry) => (
                      <div key={entry.id} className={styles.timelineItem}>
                        <div className={styles.timelineMarker}>
                          <div className={styles.timelineIcon}>{entry.icon}</div>
                        </div>
                        <div className={styles.timelineContent}>
                          <h3>{entry.shortTitle}</h3>
                          <p className={styles.timelinePeriod}>{toTimelinePeriod(entry.period)}</p>
