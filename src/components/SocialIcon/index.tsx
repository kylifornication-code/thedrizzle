...
/**
 * Inline SVG social icons — replaces the entire FontAwesome CDN dependency.
 * Each SVG is ~500 bytes vs the ~100KB+ FontAwesome kit.
 */
...
export default function SocialIcon({platform, className}: SocialIconProps): JSX.Element | null {
...
/**
 * Given a URL, returns the matching platform key or null.
 */
